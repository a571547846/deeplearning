...
#以下是运行此cell后报的警告，如果以后代码出错，应该就是下面说的一些api废弃了，在这里找原因。
...
#<ipython-input-2-feccd04fb558>:62: SyntaxWarning: assertion is always true, perhaps remove parentheses?
#  assert(parameters['W' + str(l)].shape == layer_dims[l], layer_dims[l-1])
#<ipython-input-2-feccd04fb558>:63: SyntaxWarning: assertion is always true, perhaps remove parentheses?
#  assert(parameters['W' + str(l)].shape == layer_dims[l], 1
